...
static void mavlink_test_heartbeat(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_heartbeat_t packet_in = {
        963497464,963497672,73.0,963498088,963498296,65,132
    };
    mavlink_heartbeat_t packet1, packet2;
        ...
        packet1.lastcmd = packet_in.lastcmd;
    ...
    mavlink_msg_heartbeat_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_heartbeat_pack(system_id, component_id, &msg , packet1.tick , packet1.position , packet1.dynamic , packet1.speed , packet1.lockstate , packet1.runstatus , packet1.lastcmd );
    mavlink_msg_heartbeat_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_heartbeat_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.tick , packet1.position , packet1.dynamic , packet1.speed , packet1.lockstate , packet1.runstatus , packet1.lastcmd );
    mavlink_msg_heartbeat_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_heartbeat_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_heartbeat_send(MAVLINK_COMM_1 , packet1.tick , packet1.position , packet1.dynamic , packet1.speed , packet1.lockstate , packet1.runstatus , packet1.lastcmd );
    mavlink_msg_heartbeat_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_runcmd(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_msg_runcmd_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_runcmd_pack(system_id, component_id, &msg , packet1.cmd , packet1.dir , packet1.distance , packet1.freq );
    mavlink_msg_runcmd_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_runcmd_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.cmd , packet1.dir , packet1.distance , packet1.freq );
    mavlink_msg_runcmd_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_runcmd_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_runcmd_send(MAVLINK_COMM_1 , packet1.cmd , packet1.dir , packet1.distance , packet1.freq );
    mavlink_msg_runcmd_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_custstep(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_custstep_t packet_in = {
        963497464,963497672,963497880,963498088,963498296,963498504,963498712,963498920,963499128,963499336,963499544,963499752,963499960,963500168,963500376
    };
    mavlink_custstep_t packet1, packet2;
        ...
        packet1.step6 = packet_in.step6;
        packet1.step7 = packet_in.step7;
        ...
        packet1.wait6 = packet_in.wait6;
        packet1.wait7 = packet_in.wait7;
    ...
    mavlink_msg_custstep_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_custstep_pack(system_id, component_id, &msg , packet1.step1 , packet1.step2 , packet1.step3 , packet1.step4 , packet1.step5 , packet1.step6 , packet1.step7 , packet1.wait1 , packet1.wait2 , packet1.wait3 , packet1.wait4 , packet1.wait5 , packet1.wait6 , packet1.wait7 , packet1.index );
    mavlink_msg_custstep_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_custstep_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.step1 , packet1.step2 , packet1.step3 , packet1.step4 , packet1.step5 , packet1.step6 , packet1.step7 , packet1.wait1 , packet1.wait2 , packet1.wait3 , packet1.wait4 , packet1.wait5 , packet1.wait6 , packet1.wait7 , packet1.index );
    mavlink_msg_custstep_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_custstep_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_custstep_send(MAVLINK_COMM_1 , packet1.step1 , packet1.step2 , packet1.step3 , packet1.step4 , packet1.step5 , packet1.step6 , packet1.step7 , packet1.wait1 , packet1.wait2 , packet1.wait3 , packet1.wait4 , packet1.wait5 , packet1.wait6 , packet1.wait7 , packet1.index );
    mavlink_msg_custstep_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
